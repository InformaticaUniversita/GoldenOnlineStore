...
public class HomeServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        categorie= categoriaDAO.doRetrieveByMacro("ActionFigure");
        getServletContext().setAttribute("categorie1",categorie);
        categorie= categoriaDAO.doRetrieveByMacro("GiochiDiCarte");
        getServletContext().setAttribute("categorie2",categorie);
        categorie= categoriaDAO.doRetrieveByMacro("Fumetti");
