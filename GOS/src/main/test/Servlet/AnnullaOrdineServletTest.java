...
public class AnnullaOrdineServletTest {
    ...
    public void doGetSuccessTest() throws ServletException, IOException {
        ...
        // Crea un mock di AnnullaOrdineServlet
        AnnullaOrdineServlet annullaOrdineServlet = Mockito.mock(AnnullaOrdineServlet.class);
        try {
            annullaOrdineServlet.doGet(httpServletRequest, httpServletResponse);
        ...
        Mockito.verify(annullaOrdineServlet).doGet(httpServletRequest, httpServletResponse);
    }
}
